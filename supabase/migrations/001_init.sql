...
-- ---------- Alta de usuario: perfil + jugador ----------
...
begin
  ...
  values (new.id, new.email, meta_name, meta_avatar, new_role, meta_team);

  insert into public.players (user_id, team_id, full_name, avatar_url)
  values (new.id, meta_team, meta_name, meta_avatar)
...
-- Players (lectura pública para espectadores y registro)
